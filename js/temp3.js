...
//pageLoad bundles commonly used functions
const pageLoad = (page) => {
  listClear(pagUl);//clears pagination
  listClear(studDiv);//clears student list
  pagination(referenceList(),page);//pagination with reference to default list
  pageSwitch(referenceList(),page);//student list with reference to default list
};
